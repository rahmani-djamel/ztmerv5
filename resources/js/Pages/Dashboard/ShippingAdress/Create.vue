      ...
      <div class="container mx-auto p-4 bg-gray-100 dark:bg-gray-900">
        ...
        <form @submit.prevent="submitForm" class="grid grid-cols-1 md:grid-cols-6 gap-4">
          ...
          <div class="bg-white dark:bg-gray-800 p-4 rounded md:col-span-2">
            ...
            <div class="mb-4">
              <label for="user_name" class="block text-gray-700 dark:text-gray-300">
                  إسم المستلم
              </label>
              <input type="text" id="user_name" v-model="form.user_name" class="w-full p-2 border border-gray-300 dark:border-gray-600 rounded dark:bg-gray-700 dark:text-gray-100" />
            </div>
            <div class="mb-4">
          ...
          <div class="bg-white dark:bg-gray-800 p-4 rounded md:col-span-4">
            <h2 class="text-lg font-bold mb-2 text-gray-900 dark:text-gray-100">
              🗺️ يرجى تحديد موقع العنوان على الخريطة لتحديد الإحداثيات 📍
            </h2>
            <GoogleMap

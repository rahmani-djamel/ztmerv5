    ...
    <div class="grid grid-cols-1 justify-center items-center bg-gray-100 dark:bg-gray-900">
      ...
      <div class="col-span-3 bg-white dark:bg-gray-800 p-6 rounded shadow-md">
        <form @submit.prevent="saveUnit">
          <div class="mb-4">
            <label for="city" class="block text-gray-700 dark:text-gray-300 text-sm font-bold mb-2">الإسم</label>
            <input
              type="text"
              id="city"
              v-model="form.name"
          ...
          <div class="mb-4">
            <label for="city" class="block text-gray-700 dark:text-gray-300 text-sm font-bold mb-2">الرمز</label>
            <input
              type="text"
              id="city"
          ...
          <div class="mb-4">
            <label for="city" class="block text-gray-700 dark:text-gray-300 text-sm font-bold mb-2">القيمة بالكيلوغرام</label>
            <input
              type="number"
              step="0.001"
              min="0"

<template>
        ...
        <div class="container mx-auto max-w-7xl px-4 py-8 bg-white rounded shadow-lg mb-4 dark:bg-gray-800">
            <div class="grid grid-cols-1 lg:grid-cols-4 gap-4">
              ...
              <div class="flex flex-col">
                ...
                <select v-model="selectedcity" class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 dark:bg-gray-700 dark:border-gray-600 dark:focus:border-indigo-500 dark:focus:ring-indigo-500 dark:focus:ring-opacity-50">
                    <option value="">
                        الكل
                    </option>
  ...
  let selectedcity = ref(props.filters.selectedcity)
  ...
  onMounted(() => {    
    ...
    watch([search,order_by,selectedcity], function (value) {    
    router.visit('/states/'+props.state.slug, {
      method: 'get',
      replace: true,
      preserveState: true,
      data: {
